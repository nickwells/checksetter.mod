...
var iMaker = MakerInfo[int]{
	Args: []string{},

	MF: func(e *ast.CallExpr, fName string) (cf check.ValCk[int], err error) {
...
var iMakerIcheckerString = MakerInfo[int]{
	Args: []string{IntCheckerName, "string"},
...
var iMakerMultiIchecker = MakerInfo[int]{
