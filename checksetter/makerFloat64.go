...
var f64Maker = MakerInfo[float64]{
	Args: []string{},

	MF: func(e *ast.CallExpr, fName string) (cf check.ValCk[float64], err error) {
...
var f64MakerF64 = MakerInfo[float64]{
	Args: []string{"float64"},

	MF: func(e *ast.CallExpr, fName string) (cf check.Float64, err error) {
		funcs := map[string]func(float64) check.Float64{
...
var f64MakerF64F64 = MakerInfo[float64]{
	Args: []string{"float64", "float64"},

	MF: func(e *ast.CallExpr, fName string) (cf check.Float64, err error) {
		funcs := map[string]func(float64, float64) check.Float64{
...
var f64MakerF64checkerString = MakerInfo[float64]{
	Args: []string{Float64CheckerName, "string"},

	MF: func(e *ast.CallExpr, fName string) (cf check.Float64, err error) {
		funcs := map[string]func(check.Float64, string) check.Float64{
...
var f64MakerMultiF64checker = MakerInfo[float64]{
	Args: []string{"...", Float64CheckerName},

	MF: func(e *ast.CallExpr, fName string) (cf check.Float64, err error) {
		funcs := map[string]func(...check.Float64) check.Float64{
